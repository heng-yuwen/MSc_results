...
for i in range(630, 700, 5):
    history = collect_wcl((x_train, y_train), (x_valid, y_valid), (x_test, y_test), None, "cifar100", 100,
                  batch_size=batch_size, i=i)
    for his in history:
        np.save(os.path.join(os.getcwd(), "models", "cifar100", "framework",
